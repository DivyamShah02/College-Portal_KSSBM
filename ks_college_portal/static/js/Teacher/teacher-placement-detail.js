...
async function HandlePlacementDetail(csrf_token_param, teacher_placement_details_url_param) {
	...
	placementId = urlParams.get("company_id");
...
async function loadPlacementDetails(placementId) {
	const Params = {
	...
	document.getElementById("company-notes").textContent = `Internship Stipend: ₹${placement.company_data.notes}`;
